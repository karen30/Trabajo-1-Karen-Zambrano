...
try{
	...
	$sql="SELECT count(aprendiz.id_apre),des_causa from aprendiz,desercion,causadesercion,ficha where desercion.id_apre=aprendiz.id_apre and desercion.num_ficha=ficha.num_ficha and desercion.cod_causa=causadesercion.cod_causa group by des_causa";
