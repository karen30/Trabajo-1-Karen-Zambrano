...
<div align="center">
  ...
  <table width="200" border="1">
    <tr>
      <td><a href="insertar/indexFicha.php">
        <input type="button" value="insertar">
      </a></td>
      <td><a href="modificar/indexFicha.php">
        <input type="button" value="modificar">
      </a></td>
      <td><a href="eliminar/indexFicha.php">
  ...
  <table width="200" border="4">
    <tr>
      <td width="128">num_ficha</td>
      <td width="50"><p>cod_programa</p></td>
      <td width="50"><p>fecha_ini</p></td>
      <td width="50"><p>fecha_fin</p></td>
      <td width="50"><p>cod_centro</p></td>
    </tr>
