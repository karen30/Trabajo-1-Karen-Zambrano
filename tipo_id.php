...
<div align="center">
  <table width="200" border="1">
    <tr>
      <td><a href="insertar/indexTipo_id.php">
        <input type="button" value="insertar">
      </a></td>
      <td><a href="modificar/indexTipo_id.php"><input type="button" value="modificar"></a></td>
      <td><a href="eliminar/indexTipo_id.php">
  ...
  <table width="200" border="4">
    <tr>
      ...
      <td width="50"><p>des_tipo_id</p></td>
      <td width="50"><p>siglas</p></td>
