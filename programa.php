...
<div align="center">
  ...
  <table width="200" border="1">
    <tr>
      <td><a href="insertar/indexPrograma.php">
        <input type="button" value="insertar">
      </a></td>
      <td><a href="modificar/indexPrograma.php">
        <input type="button" value="modificar">
      </a></td>
      <td><a href="eliminar/indexPrograma.php">
  ...
  <table width="200" border="4">
    <tr>
      <td width="128">cod_prog</td>
      <td width="50"><p>des_prog</p></td>
