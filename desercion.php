...
<div align="center">
  <table width="200" border="1">
    <tr>
      <td><a href="insertar/indexDesercion.php">
        <input type="button" value="insertar">
      </a></td>
      <td><a href="modificar/indexDesercion.php">
        <input type="button" value="modificar">
      </a></td>
      <td><a href="eliminar/indexDesercion.php">
  ...
  <table width="200" border="4">
    <tr>
      <td width="128">num_doc</td>
      <td width="50"><p>fecha</p></td>
      <td width="50"><p>id_apre</p></td>
      <td width="50"><p>num_ficha</p></td>
      <td width="50"><p>cod_causa</p></td>
      <td width="50"><p>fecha_desercion</p></td>
      <td width="50"><p>fase_desercion</p></td> 
    </tr>
